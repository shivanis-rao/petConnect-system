...
export default (sequelize, DataTypes) => {
  class AdoptionApplication extends Model {
    static associate(models) {
      AdoptionApplication.belongsTo(models.User,    { foreignKey: 'userId',    as: 'applicant' });
      AdoptionApplication.belongsTo(models.Pet,     { foreignKey: 'petId',     as: 'pet'       });
      AdoptionApplication.belongsTo(models.Shelter, { foreignKey: 'shelterId', as: 'shelter'   });
    }
  }
  ...
  AdoptionApplication.init(
    {
      ...
      petExperienceYears: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
